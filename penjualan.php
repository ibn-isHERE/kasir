                    ...
                    <?php if (numRows($transaksiList) > 0): ?>
                        <?php while ($row = fetchArray($transaksiList)): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="detail_transaksi.php?id=<?php echo $row['PenjualanID']; ?>" 
                                       class="btn btn-info btn-sm">📄 Detail</a>
                                    <a href="cetak_nota.php?id=<?php echo $row['PenjualanID']; ?>" 
                                       class="btn btn-secondary btn-sm" target="_blank">🖨️ Cetak</a>

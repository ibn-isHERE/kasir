...
<div class="page-header">
    ...
    <p>Rekapitulasi penjualan Anda</p>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="GET" action="" style="display: grid; grid-template-columns: 1fr 1fr auto auto; gap: 15px; align-items: end;">
            ...
            <a href="cetak_laporan_petugas.php?mulai=<?php echo $filterMulai; ?>&sampai=<?php echo $filterSampai; ?>" 
               class="btn btn-success" target="_blank">🖨️ Cetak</a>
        </form>
    </div>
</div>
